...
class TestsParametrizedStorage(unittest.TestCase):
    ...
    def test_storage_add_item_wrong(self):
        assert_that(self.storage.dodaj_przedmiot).raises(ValueError).when_called_with(self.class_wrong_value)
    ...
    def test_storage_remove_order_wrong(self):
        assert_that(self.storage.usun_zamowienie).raises(ValueError).when_called_with(self.int_wrong_value)

    def test_storage_remove_item_wrong(self):
        assert_that(self.storage.usun_przedmiot).raises(ValueError).when_called_with(self.int_wrong_value)

    def test_storage_find_client_wrong(self):
        assert_that(self.storage.znajdz_klienta).raises(ValueError).when_called_with(self.int_wrong_value)
    
    def test_storage_find_order_wrong(self):
        assert_that(self.storage.znajdz_zamowienie).raises(ValueError).when_called_with(self.int_wrong_value)

    def test_storage_find_item_wrong(self):
        assert_that(self.storage.znajdz_przedmiot).raises(ValueError).when_called_with(self.int_wrong_value)
