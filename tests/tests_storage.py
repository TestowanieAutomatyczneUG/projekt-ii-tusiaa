...
class TestsStorage(unittest.TestCase):
    ...
    def setUp(self, mock_czytaj_przedmioty, mock_czytaj_przedmioty_z_zamowien, mock_czytaj_zamowienia, mock_czytaj_klientow):
        ...
        self.storage.klienci.append(Klient(mock_czytaj_klientow()[0]))
        self.storage.zamowienia.append(Zamowienie(mock_czytaj_zamowienia()[0]))
        self.storage.przedmioty.append(Przedmiot(mock_czytaj_przedmioty()[0]))
