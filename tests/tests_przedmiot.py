...
class TestsPrzedmiot(unittest.TestCase):
    ...
    @patch.object(Baza_Danych, 'dodaj_przedmiot', autospec=True)
    ...
    @patch.object(Baza_Danych, 'dodaj_przedmiot', side_effect=[None, ValueError], autospec=True)
    ...
    @patch.object(Baza_Danych, 'usun_przedmiot', autospec=True)
    ...
    @patch.object(Baza_Danych, 'usun_przedmiot', side_effect=[None, ValueError], autospec=True)
    ...
    @patch.object(Baza_Danych, 'edytuj_przedmiot', autospec=True)
